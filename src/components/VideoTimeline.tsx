    ...
    <div className="bg-gray-900 rounded-lg p-4 border border-gray-700">
      ...
      <div className="flex items-center space-x-4 mb-4">
        ...
        <div className="flex items-center space-x-2 text-gray-400">
          <span className="w-4 h-4 bg-gray-600 rounded-sm cursor-pointer hover:bg-gray-500 transition-colors"></span>
          <span className="text-xs">Undo</span>
          <span className="w-4 h-4 bg-gray-600 rounded-sm cursor-pointer hover:bg-gray-500 transition-colors ml-2"></span>
      ...
      <div 
        ref={timelineRef}
        className="relative bg-gray-800 rounded border border-gray-600 cursor-pointer"
          ...
          <div className="flex-1 h-12 bg-gray-900 rounded relative overflow-hidden">
            ...
            <div className="flex items-center h-full px-2">
              {waveformData.map((amplitude, index) => (
                <div
                  key={index}
                  className="bg-blue-400 mx-px rounded-full"
                  style={{
          ...
          <div className="flex-1 h-12 bg-gray-900 rounded relative overflow-hidden">
            ...
            <div className="flex h-full">
              {thumbnails.map((thumb, index) => (
                <div
                  key={index}
                  className="flex-1 min-w-0 h-full bg-cover bg-center border-r border-gray-700 last:border-r-0"
                  style={{
